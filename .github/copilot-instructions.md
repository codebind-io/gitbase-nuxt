...
- **ALWAYS** check for and synchronize properties between the **Sveltia CMS schema (`gitbase.config.yml`)** and the **Nuxt Content database configuration (`nuxt.config.ts` or custom JSON models)**.
